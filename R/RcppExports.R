...
authenticate_Impl <- function(con_, uuid_, ip_address_, token_) {
    .Call(Rblpapi_authenticate_Impl, con_, uuid_, ip_address_, token_)
}

bdh_Impl <- function(con_, securities, fields, start_date_, end_date_, options_, overrides_, verbose, identity_, int_as_double) {
    .Call(Rblpapi_bdh_Impl, con_, securities, fields, start_date_, end_date_, options_, overrides_, verbose, identity_, int_as_double)
}

bdp_Impl <- function(con_, securities, fields, options_, overrides_, verbose, identity_) {
    .Call(Rblpapi_bdp_Impl, con_, securities, fields, options_, overrides_, verbose, identity_)
}

bds_Impl <- function(con_, securities, field, options_, overrides_, verbose, identity_) {
    .Call(Rblpapi_bds_Impl, con_, securities, field, options_, overrides_, verbose, identity_)
}

getPortfolio_Impl <- function(con_, securities, field, options_, overrides_, verbose, identity_) {
    .Call(Rblpapi_getPortfolio_Impl, con_, securities, field, options_, overrides_, verbose, identity_)
}

beqs_Impl <- function(con, screenName, screenType, group, pitdate, languageId, verbose = FALSE) {
    .Call(Rblpapi_beqs_Impl, con, screenName, screenType, group, pitdate, languageId, verbose)
}

blpConnect_Impl <- function(host, port, authOptions) {
    .Call(Rblpapi_blpConnect_Impl, host, port, authOptions)
}

blpGenerateToken_Impl <- function(con_) {
    .Call(Rblpapi_blpGenerateToken_Impl, con_)
}
...
getRuntimeVersion <- function() {
    .Call(Rblpapi_getRuntimeVersion)
}

bsrch_Impl <- function(con, domain, limit, verbose = FALSE) {
    .Call(Rblpapi_bsrch_Impl, con, domain, limit, verbose)
}

fieldSearch_Impl <- function(con, searchterm, excludeterm) {
    .Call(Rblpapi_fieldSearch_Impl, con, searchterm, excludeterm)
}

getBars_Impl <- function(con, security, eventType, barInterval, startDateTime, endDateTime, options, verbose = FALSE) {
    .Call(Rblpapi_getBars_Impl, con, security, eventType, barInterval, startDateTime, endDateTime, options, verbose)
}

fieldInfo_Impl <- function(con_, fields) {
    .Call(Rblpapi_fieldInfo_Impl, con_, fields)
}

getTicks_Impl <- function(con, security, eventType, startDateTime, endDateTime, setCondCodes = TRUE, verbose = FALSE) {
    .Call(Rblpapi_getTicks_Impl, con, security, eventType, startDateTime, endDateTime, setCondCodes, verbose)
}
...
lookup_Impl <- function(con, query, yellowKeyFilter = "YK_FILTER_NONE", languageOverride = "LANG_OVERRIDE_NONE", maxResults = 20L, verbose = FALSE) {
    .Call(Rblpapi_lookup_Impl, con, query, yellowKeyFilter, languageOverride, maxResults, verbose)
}

subscribe_Impl <- function(con_, securities, fields, fun, options_, identity_) {
    .Call(Rblpapi_subscribe_Impl, con_, securities, fields, fun, options_, identity_)
}
