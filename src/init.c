...
/* .Call calls */
extern SEXP Rblpapi_authenticate_Impl(SEXP, SEXP, SEXP, SEXP);
...
extern SEXP Rblpapi_blpConnect_Impl(SEXP, SEXP, SEXP);
...
extern SEXP Rblpapi_blpGenerateToken_Impl(SEXP);

static const R_CallMethodDef CallEntries[] = {
    {"Rblpapi_authenticate_Impl", (DL_FUNC) &Rblpapi_authenticate_Impl,  4},
    ...
    {"Rblpapi_blpConnect_Impl",   (DL_FUNC) &Rblpapi_blpConnect_Impl,    3},
    ...
    {"Rblpapi_blpGenerateToken_Impl", (DL_FUNC) &Rblpapi_blpGenerateToken_Impl, 1},
    {NULL, NULL, 0}
};
